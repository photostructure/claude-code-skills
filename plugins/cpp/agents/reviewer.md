---
name: reviewer
description: Leaf worker for an active C++ resource review. Use only when a parent explicitly assigns role leaf-reviewer and delegation-budget 0; never use for a direct user request.
...
Read `${CLAUDE_PLUGIN_ROOT}/skills/resource-review/references/validation-pass.md`
